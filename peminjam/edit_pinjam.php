...
if (isset($_GET['PeminjamID'])) {
    ...
    $query = "SELECT * FROM peminjaman WHERE PeminjamID='$PeminjamID'";
            ...
            <div class="bg-primary rounded h-100 p-4">
                ...
                <form method="POST" action="proses_update_pinjam.php">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="PeminjamID" type="text" class="form-control" value="<?php echo $d_koleksi['PeminjamID']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
