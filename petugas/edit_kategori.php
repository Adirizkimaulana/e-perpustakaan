                ...
                <div class="bg-primary bg-gradient rounded h-100 p-4">
                    ...
                    <form method="POST" action="proses_update_kategori.php">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="KategoriID" type="text" class="form-control" value="<?php echo $d['KategoriID']; ?>" readonly>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputText3" class="col-sm-2 col-form-label">NAMA KATEGORI</label>
                            <div class="col-sm-10">
                                <input name="NamaKategori" type="text" class="form-control" required="" value="<?php echo $d['NamaKategori']; ?>">
                            </div>
                        </div>
